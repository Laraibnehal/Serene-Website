...
const Footer = () => {
  return (
    <div className="w-screen p-4 md:p-8 md:py-12 bg-yellow-950 text-white ">
        ...
        <div className="flex flex-col md:flex-row justify-between">
          <div className="flex flex-col">
           ...
           <h2 className="pb-5">Contact Us at</h2>
            ...
            <p className="ml-2 flex"><span className="mx-3">Email -</span> perfumeserene@gmail.com</p>
       
           </div>
           <div className="">
           <Link to='https://www.instagram.com/___serene.__/'>

           <i className="fa-brands fa-instagram flex-col px-7 text-4xl mx-14 my-4" style={{color: "#d1e0d4"}}></i>
           </Link>
           </div>
      ...
      <div>
        <p className="text-center text-xs mt-3 mb-0 justify-center text-center ">© 2023,Serene created by <a href="https://github.com/Laraibnehal" className="text-cyan-200">Laraib Nehal</a> </p>
      </div>
    </div>
  );
};

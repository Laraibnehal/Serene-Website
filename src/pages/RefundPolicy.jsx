...
function RefundPolicy() {
  return (
    <div>
       <p className='text-center py-5 w-1/2 my-4 bg-black text-white mx-5 rounded-full'>Return and Refunds Policy</p>
    ...
    <p className='text-center py-5 w-1/2 my-4 bg-black text-white mx-5 rounded-full'>Exchanges</p>
    ...
    <p className='text-center py-5 w-1/2 my-4 bg-black text-white mx-5 rounded-full'>Refunds</p>
